...
console.log(date6(dateNow.getHours()) + ':' + date6(dateNow.getMinutes()) + ':' + date6(dateNow.getSeconds()) + ' ' + date6(dateNow.getDate()) + '.' + date6(dateNow.getMonth()+1) + '.' + dateNow.getFullYear());

// задание 7

let str7 = 'aa aba abba abbba abca abea';
console.log(str7);
console.log(str7.match(/ab{1,5}a/g));
...
if(regexp.test(phoneNumber) === true) {
    console.log(phoneNumber, 'Номер введён верно');
    //return true
} else {
    console.log(phoneNumber, 'Номер введён неверно');
    //return false
}
}
